...
export default function game() {
  ...
  return (
        ...
        <DefaultLayout className="px-2 w-full" style={{ paddingTop: '180px' }}>
          <div className="relative z-[3] flex w-full flex-col items-center justify-start px-4 pb-6 sm:pb-8 md:pb-10">
            <div className="animate-fadeInUp relative flex w-full max-w-[1100px] items-center justify-center">
              <h1
                className="m-0 p-0 text-5xl sm:text-5xl md:text-[64px] lg:text-[84px] leading-none font-[Firlest] lowercase whitespace-nowrap text-center"
                style={textStyle}
              >
                <span className="block lg:inline-block">permainan</span> {''}
                <span className="block lg:inline-block">interaktif</span>
              </h1>
            </div>
          </div>
          ...
          <div className="relative mt-5 sm:mt-8 w-full max-w-[1500px] mx-auto flex justify-center max-h-[calc(95vh-80px)] min-h-[900px]">
            <div className="relative w-full max-w-[1500px] [--nala-w:220px] sm:[--nala-w:320px] md:[--nala-w:420px] lg:[--nala-w:520px]">
              <Image
                ...
                alt=""
                className="animate-fadeInUp pointer-events-none absolute right-[-5rem] -top-10 z-0 h-auto -translate-y-1/2 object-contain md:-top-13 md:right-[-6rem] lg:-top-15 lg:right-[-6rem]"
