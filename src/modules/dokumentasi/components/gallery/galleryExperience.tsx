...
function SpinningGear() {
  return (
    <div
      className="absolute -bottom-8 -right-8 sm:-bottom-12 sm:-right-12 w-[80px] h-[80px] sm:w-[150px] sm:h-[150px] md:-bottom-[80px] md:-right-[80px] md:w-[200px] md:h-[200px] -z-10 animate-spin"
    ...
    <div ref={triggerRef} className="relative h-full w-full">
      ...
      >
        ...
        >
          ...
          <div
            ref={titleRef}
            className="gallery-card-offset absolute z-50 flex flex-col items-center justify-center will-change-transform"
          >
