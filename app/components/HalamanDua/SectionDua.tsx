    ...
    <DefaultLayout className="!p-0 !gap-0" aria-label="Selamat Datang Kesatria Muda 2026">
      <div ref={sectionRef} id="section-dua" className="kesatria-section-2" aria-label="Selamat Datang Kesatria Muda 2026">
        <div className="kain-transition-wrapper" aria-hidden="true">
          <Image src="/section2/kain.svg" alt="" width={1920} height={383} className="block w-full h-auto" loading="lazy" />
        </div>
        <div className="section-dua-inner">
          <div className="bg-pattern-wrapper" aria-hidden="true">
            <Image src="/section2/background.svg" alt="" fill sizes="100vw" className="object-cover opacity-70" loading="lazy" />
          </div>
          {GUNUNGAN_POSITIONS.map((cls) => (
            <Image
              key={cls}
              src="/section2/gunungan.svg"
              alt=""
              width={582}
              height={766}
          ...
          <div className="main-content-wrapper">
            <div className="logo-container">
              <Image src="/section2/logo.svg" alt="Logo Kesatria Muda 2026" width={155} height={124} className="w-full h-auto" priority />
            </div>
            ...
            <div className={`video-frame-container${isVideoActivated ? " is-video-playing" : ""}`}>
              <Image src="/section2/screen5.svg" alt="" width={962} height={556} className="video-screen-layer screen-layer-5" aria-hidden="true" loading="lazy" />
              ...
              <Image src="/section2/screen2.svg" alt="" width={974} height={564} className="video-screen-layer screen-layer-2" aria-hidden="true" loading="lazy" />
              <Image src="/section2/screen1.svg" alt="" width={167} height={175} className="video-screen-layer screen-layer-1" aria-hidden="true" loading="lazy" />
            </div>
          </div>
          <div className="smoke-wrapper" aria-hidden="true">
            <Image src="/section2/efek.svg" alt="" width={1920} height={280} className="w-full h-auto" loading="lazy" />
          </div>
        </div>
        <div className="awan-transition-wrapper" aria-hidden="true">
          <Image src="/section2/awan.svg" alt="" width={1920} height={659} className="block w-full h-auto" loading="lazy" />
        </div>
      </div>
    </DefaultLayout>
  );
